...
# Header only libraries for modules that need gtest_prod.h. Modules should pull
# this in with LOCAL_WHOLE_STATIC_LIBRARIES so that their users will also get
# the include paths.
include $(CLEAR_VARS)
